...
{
	UENC_ActualPosition.Value += 100;
	if(UENC_ActualPosition.Value >= 2700)
	{
		UENC_ActualPosition.Value = 1800;
	}
	CAN_TxData[0] = 'P';
	CAN_TxData[1] = 'R';
	CAN_TxData[2] = 0;
	...
	UCAN_Transmit(CAN1, 0x122, 8, CAN_TxData);
}

void UCAN_Thruster(void)
{
	UENC_ActualPosition.Value += 10;
	if(UENC_ActualPosition.Value >= 100)
	{
		UENC_ActualPosition.Value = 0;
	}
	CAN_TxData[0] = 'R';
	CAN_TxData[1] = 'P';
	CAN_TxData[2] = 'V';
...
{
	UENC_ActualPosition.Value += 10;
	if(UENC_ActualPosition.Value >= 58)
	{
		UENC_ActualPosition.Value = 0;
	}
	CAN_TxData[0] = 'P';
	...
	UCAN_Transmit(CAN1, 0x121, 8, CAN_TxData);
}

void UCAN_Pistol(void)
{
	UENC_ActualPosition.Value += 10;
	if(UENC_ActualPosition.Value >= 90)
	{
		UENC_ActualPosition.Value = 0;
	}
	CAN_TxData[0] = 'P';
...
{
	UENC_ActualPosition.Value += 1;
	if(UENC_ActualPosition.Value >= 10)
	{
		UENC_ActualPosition.Value = 0;
	}
	CAN_TxData[0] = 'R';
