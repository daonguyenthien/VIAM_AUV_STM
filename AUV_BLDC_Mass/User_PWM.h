...
//#define PWM_DC_MAX				1500	//PWM duty cycle maximum = Full_Duty - 3 * Dead-time = 3599 - 81 = 3566  For safety: 90% = 3209
	 
// Frequency 25KHz
//#define PWM_DC_MIN				81  //PWM duty cycle minimum >= 3 * Dead-time = 3 * 27(DutyCycle) = 81  (Dead-time = 7 duty cycle)
//#define PWM_DC_MAX				2800	//PWM duty cycle maximum = Full_Duty - 3 * Dead-time = 3599 - 81 = 3566  For safety: 90% = 3209
...
// Frequency 19.2KHz
//#define PWM_DC_MIN				81  //PWM duty cycle minimum >= 3 * Dead-time = 3 * 27(DutyCycle) = 81  (Dead-time = 7 duty cycle)
//#define PWM_DC_MAX				3700	//PWM duty cycle maximum = Full_Duty - 3 * Dead-time = 3599 - 81 = 3566  For safety: 90% = 3209

// Frequency 18KHz
#define PWM_DC_MIN				81  //PWM duty cycle minimum >= 3 * Dead-time = 3 * 27(DutyCycle) = 81  (Dead-time = 7 duty cycle)
#define PWM_DC_MAX				3900//3900	//PWM duty cycle maximum = Full_Duty - 3 * Dead-time = 3599 - 81 = 3566  For safety: 90% = 3209

// Frequency 15KHz
//#define PWM_DC_MIN				81  //PWM duty cycle minimum >= 3 * Dead-time = 3 * 27(DutyCycle) = 81  (Dead-time = 7 duty cycle)
//#define PWM_DC_MAX				4700	//PWM duty cycle maximum = Full_Duty - 3 * Dead-time = 3599 - 81 = 3566  For safety: 90% = 3209
