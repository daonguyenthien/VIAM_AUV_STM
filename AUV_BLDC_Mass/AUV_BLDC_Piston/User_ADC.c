...
void DMA1_Channel1_IRQHandler(void)
{
		if(DMA_GetITStatus(DMA1_IT_TC1))
		{
			...
			//G = 1 + R1/R2; R1 = 10 Kohm, R2 = 1 KOhm; I = Uout/R
			// I = Uin/G*0.001 = ADC*Vref/(G*4095*0.001) (A)
//			UADC_iMotor.Value = (float)UADC_GetAvrValue(iMotor)*1000.0*3.3/(681.0*4095.0*0.03);
			float a = (float)UADC_GetAvrValue(iMotor)*3.3/4096*100.0;
			UADC_iMotor.Value = UFIL_1stOrderFilter_Output(&myFilter, a);
